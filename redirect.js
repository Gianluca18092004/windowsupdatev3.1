...
var conRedrThanks = V5Site + "/v5consumer/" + "default.aspx?g_sconsumersite&" ;
...
ClientEnvironment.prototype = {
    ...
    /// </summary>
    /// <returns>
    ///     One of conOSWin2K, conOSWinXP, conOSWin2003, conOSVista, conOSWin7
...
Redirector.prototype = 
{
    ...
    _get95NT4Url: function(redirectorDestination)
    {
        ...
        if((userAgent.indexOf("windows 95") > 0) || (userAgent.indexOf("windows 98") > 0) || ( userAgent.indexOf("windows nt)") >0 ) || ( userAgent.indexOf("windows nt;") >0 )  || ( userAgent.indexOf("windows nt 4") > 0 ) ) {
